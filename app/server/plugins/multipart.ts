...
/**
 * Registers the @fastify/multipart plugin.
 * Consider adding limits (fileSize, files, etc.) for security.
 * See: https://github.com/fastify/fastify-multipart#plugin-options
 */
export default fp(
  async fastify => {
