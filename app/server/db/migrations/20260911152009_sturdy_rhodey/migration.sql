CREATE TYPE "ssh_branch_access_block_reason" AS ENUM('branch_created', 'branch_forked', 'branch_stop', 'snapshot_create', 'capsule_archive', 'capsule_destroy', 'admin_revoked', 'policy_failure');--> statement-breakpoint
...
CREATE TYPE "capsule_operation_type" AS ENUM('create', 'fork', 'archive', 'unarchive', 'destroy', 'snapshot_create', 'branch_start', 'branch_stop', 'promote', 'rollback');--> statement-breakpoint
...
CREATE TYPE "capsule_snapshot_create_resource_status" AS ENUM('planned', 'creating', 'created', 'deleting', 'deleted', 'missing', 'error');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "capsule_branch_runtime_operations" (
...
CREATE TABLE "capsule_branches" (
	...
	CONSTRAINT "capsule_branches_inactive_runtime_ip_check" CHECK ((
          "status" NOT IN ('offline', 'snapshotting')
...
--> statement-breakpoint
CREATE TABLE "capsule_snapshot_create_operations" (
	"operation_id" uuid PRIMARY KEY,
	...
	"rootfs_image_pin" jsonb NOT NULL,
	"snapshot_id" uuid,
	CONSTRAINT "capsule_snapshot_create_operations_blueprint_schema_check" CHECK ("blueprint_schema_version" = 1),
	CONSTRAINT "capsule_snapshot_create_operations_blueprint_digest_check" CHECK ("blueprint_digest" ~ '^sha256:[a-f0-9]{64}$'),
	CONSTRAINT "capsule_snapshot_create_operations_inventory_digest_check" CHECK ("source_branch_resource_inventory_digest" ~ '^sha256:[a-f0-9]{64}$')
);
--> statement-breakpoint
CREATE TABLE "capsule_snapshot_create_resources" (
	"id" uuid PRIMARY KEY DEFAULT uuidv7(),
	"operation_id" uuid NOT NULL,
	...
	"status" "capsule_snapshot_create_resource_status" DEFAULT 'planned'::"capsule_snapshot_create_resource_status" NOT NULL,
	"failure_code" text,
	"failure_message" text,
	"failure_details" jsonb,
	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "capsule_snap_create_resources_identity_check" CHECK ((
...
CREATE TABLE "capsule_snapshot_resource_references" (
	...
	"snapshot_id" uuid NOT NULL,
	"source_branch_resource_id" uuid NOT NULL,
	"create_resource_id" uuid NOT NULL,
	"provider" "capsule_snapshot_resource_provider" NOT NULL,
	"kind" "capsule_snapshot_resource_kind" NOT NULL,
	"blueprint_volume_name" text NOT NULL,
	"project" text NOT NULL,
...
CREATE INDEX "capsule_branch_runtime_operations_branch_idx" ON "capsule_branch_runtime_operations" ("branch_id");--> statement-breakpoint
...
CREATE INDEX "capsule_snapshot_create_operations_source_branch_idx" ON "capsule_snapshot_create_operations" ("source_branch_id");--> statement-breakpoint
CREATE INDEX "capsule_snapshot_create_operations_blueprint_digest_idx" ON "capsule_snapshot_create_operations" ("blueprint_digest");--> statement-breakpoint
CREATE UNIQUE INDEX "capsule_snapshot_create_operations_snapshot_unique_idx" ON "capsule_snapshot_create_operations" ("snapshot_id");--> statement-breakpoint
CREATE INDEX "capsule_snap_create_resources_operation_idx" ON "capsule_snapshot_create_resources" ("operation_id");--> statement-breakpoint
CREATE INDEX "capsule_snap_create_resources_source_resource_idx" ON "capsule_snapshot_create_resources" ("source_branch_resource_id");--> statement-breakpoint
CREATE INDEX "capsule_snap_create_resources_status_idx" ON "capsule_snapshot_create_resources" ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "capsule_snap_create_resources_operation_source_unique_idx" ON "capsule_snapshot_create_resources" ("operation_id","source_branch_resource_id");--> statement-breakpoint
CREATE UNIQUE INDEX "capsule_snap_create_resources_operation_volume_unique_idx" ON "capsule_snapshot_create_resources" ("operation_id","blueprint_volume_name");--> statement-breakpoint
CREATE UNIQUE INDEX "capsule_snap_create_resources_provider_identity_unique_idx" ON "capsule_snapshot_create_resources" ("provider","project","pool","source_volume","snapshot_name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "capsule_snap_resource_ref_create_resource_unique_idx" ON "capsule_snapshot_resource_references" ("create_resource_id");--> statement-breakpoint
CREATE UNIQUE INDEX "capsule_snap_resource_ref_snapshot_source_unique_idx" ON "capsule_snapshot_resource_references" ("snapshot_id","source_branch_resource_id");--> statement-breakpoint
...
ALTER TABLE "ssh_tickets" ADD CONSTRAINT "ssh_tickets_branch_id_capsule_branches_id_fkey" FOREIGN KEY ("branch_id") REFERENCES "capsule_branches"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "capsule_branch_runtime_operations" ADD CONSTRAINT "capsule_branch_runtime_operations_GwiY7vP2YwPT_fkey" FOREIGN KEY ("operation_id") REFERENCES "capsule_operations"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "capsule_branch_runtime_operations" ADD CONSTRAINT "capsule_branch_runtime_operations_1oTPfeXoHny4_fkey" FOREIGN KEY ("branch_id") REFERENCES "capsule_branches"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "capsule_snapshot_create_operations" ADD CONSTRAINT "capsule_snapshot_create_operations_QAGcBOfQPIdJ_fkey" FOREIGN KEY ("operation_id") REFERENCES "capsule_operations"("id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "capsule_snapshot_create_operations" ADD CONSTRAINT "capsule_snapshot_create_operations_QtXQ0wNZQUNg_fkey" FOREIGN KEY ("source_branch_id") REFERENCES "capsule_branches"("id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "capsule_snapshot_create_operations" ADD CONSTRAINT "capsule_snapshot_create_operations_w8CGr41jw28V_fkey" FOREIGN KEY ("snapshot_id") REFERENCES "capsule_snapshots"("id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "capsule_snapshot_create_resources" ADD CONSTRAINT "capsule_snapshot_create_resources_XGScOL6eoFDi_fkey" FOREIGN KEY ("operation_id") REFERENCES "capsule_snapshot_create_operations"("operation_id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "capsule_snapshot_create_resources" ADD CONSTRAINT "capsule_snapshot_create_resources_ieq8AsHMHNFg_fkey" FOREIGN KEY ("source_branch_resource_id") REFERENCES "capsule_branch_resources"("id") ON DELETE RESTRICT;--> statement-breakpoint
