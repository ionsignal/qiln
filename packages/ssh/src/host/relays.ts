...
type SshPublicKeyRow = SshPersistence['tables']['sshPublicKeys']['$inferSelect']
type SshBranchGrantRow = SshPersistence['tables']['sshBranchGrants']['$inferSelect']
type SshTicketRow = SshPersistence['tables']['sshTickets']['$inferSelect']
type SshRelayRow = SshPersistence['tables']['sshRelays']['$inferSelect']
